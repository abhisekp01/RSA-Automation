...
public class walkerStepDefinition {
	
	private WebDriver driver=driverManager.getDriver();

	
	@Given("user is on weekly page of WalkerSouthRoad")
	public void user_is_on_weekly_page_of_walker_south_road() throws InterruptedException {
	...
	@Then("I count the total number in WalkerSouthRoad")
	public void i_count_the_total_number_in_walker_south_road() throws InterruptedException {
	...
	@When("I click on products in WalkerSouthRoad market")
	public void i_click_on_products_in_walker_south_road_market() throws InterruptedException {
	...
	@When("I count all products in WalkerSouthRoad market")
	public void i_count_all_products_in_walker_south_road_market() throws InterruptedException {
