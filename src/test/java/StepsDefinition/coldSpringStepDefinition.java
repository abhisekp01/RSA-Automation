...
public class coldSpringStepDefinition {
	
	private WebDriver driver=driverManager.getDriver();
	
	@Given("user is on weekly page of Cold Spring")
	public void user_is_on_weekly_page_of_cold_spring() throws InterruptedException {
		
        driver.get("https://www.tealsmarket.com");
	...
	@Then("I count the total number in Cold Spring")
	public void i_count_the_total_number_in_cold_spring() throws InterruptedException {
	...
	@When("I click on products in Cold Spring market")
	public void i_click_on_products_in_cold_spring_market() throws InterruptedException {
	...
	@And("I count all products in Cold Spring market")
	public void i_count_all_products_in_cold_spring_market() throws InterruptedException {
