...
public class milacaStepDefinition {
	
	private WebDriver driver=driverManager.getDriver();

	
	@Given("user is on weekly page of Milaca")
	public void user_is_on_weekly_page_of_milaca() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/div[1]/div/div/div[3]/div[2]/div[1]/div[2]/div/div[2]/div[2]/div/div[2]/div/ul/li[5]")).click();
	...
	@Then("I count the total number in Milaca")
	public void i_count_the_total_number_in_milaca() throws InterruptedException {
	...
	@When("I click on products in Milaca market")
	public void i_click_on_products_in_milaca_market() throws InterruptedException {
	...
	@And("I count all products in Milaca market")
	public void i_count_all_products_in_milaca_market() throws InterruptedException {
