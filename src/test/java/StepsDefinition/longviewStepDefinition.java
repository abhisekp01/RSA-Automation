...
public class longviewStepDefinition {
	
	private WebDriver driver=driverManager.getDriver();
	
	@Given("user is on weekly page of Longview")
	public void user_is_on_weekly_page_of_longview() throws InterruptedException {
	...
	@Then("I count the total number in Longview")
	public void i_count_the_total_number_in_longview() throws InterruptedException {
	...
	@When("I click on products in Longview market")
	public void i_click_on_products_in_longview_market() throws InterruptedException {
	...
	@And("I count all products in Longview market")
	public void i_count_all_products_in_longview_market() throws InterruptedException {
