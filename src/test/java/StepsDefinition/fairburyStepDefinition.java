...
public class fairburyStepDefinition {
	
	private WebDriver driver=driverManager.getDriver();

	
	
	@Given("user is on weekly page of Fairbury")
	public void user_is_on_weekly_page_of_fairbury() throws InterruptedException {
	...
	@Then("I count the total number in Fairbury")
	public void i_count_the_total_number_in_fairbury() throws InterruptedException {
	...
	@When("I click on products in Fairbury market")
	public void i_click_on_products_in_fairbury_market() throws InterruptedException {
	...
	@And("I count all products in Fairbury")
	public void i_count_all_products_in_fairbury() throws InterruptedException {
