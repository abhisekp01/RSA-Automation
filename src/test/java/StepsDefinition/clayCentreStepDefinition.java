...
public class clayCentreStepDefinition {
	
	
	private WebDriver driver=driverManager.getDriver();
	
	@Given("user is on weekly page of ClayCentre")
	public void user_is_on_weekly_page_of_clay_centre() throws InterruptedException {
	...
	@Then("I count the total number in ClayCentre")
	public void i_count_the_total_number_in_clay_centre() throws InterruptedException {
	...
	@When("I click on products in ClayCentre market")
	public void i_click_on_products_in_clay_centre_market() throws InterruptedException {
	...
	@And("I count all products in ClayCentre market")
	public void i_count_all_products_in_clay_centre_market() throws InterruptedException {
