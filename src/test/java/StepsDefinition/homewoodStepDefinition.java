...
public class homewoodStepDefinition {
	
	private WebDriver driver=driverManager.getDriver();

	
	
	@Given("user is on weekly page of Homewood")
	public void user_is_on_weekly_page_of_homewood() throws InterruptedException {
		...
		WebElement option = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/div[1]/div/div/div[3]/div[2]/div[1]/div[2]/div/div[2]/div[2]/div/div[2]/div/ul/li[4]"));

		option.click();		
	    	}

	@Then("I count the total number in Homewood")
	public void i_count_the_total_number_in_homewood() throws InterruptedException {
	...
	@When("I click on products in Homewood market")
	public void i_click_on_products_in_homewood_market() throws InterruptedException {
	...
	@And("I count all products in Homewood market")
	public void i_count_all_products_in_homewood_market() throws InterruptedException {
