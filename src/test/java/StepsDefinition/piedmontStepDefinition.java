...
public class piedmontStepDefinition {
	
	private WebDriver driver=driverManager.getDriver();

	
	
	@Given("user is on all products page of Piedmont")
	public void user_is_on_all_products_page_of_piedmont() throws InterruptedException {
	...
	@And("I count the total number in Piedmont")
	public void i_count_the_total_number_in_piedmont() throws InterruptedException {
