...
public class phillipsburgStepDefinition {
	
	private WebDriver driver=driverManager.getDriver();

	
	
	@Given("user is on weekly page of  Phillipsburg")
	public void user_is_on_weekly_page_of_phillipsburg() throws InterruptedException {
	...
	@Then("I count the total number in  Phillipsburg")
	public void i_count_the_total_number_in_phillipsburg() throws InterruptedException {
	...
	@When("I click on products in  Phillipsburg market")
	public void i_click_on_products_in_phillipsburg_market() throws InterruptedException {
	...
	@And("I count all products in  Phillipsburg market")
	public void i_count_all_products_in_phillipsburg_market() throws InterruptedException {
