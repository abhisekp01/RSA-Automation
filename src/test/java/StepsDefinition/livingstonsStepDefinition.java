...
public class livingstonsStepDefinition {
	
	private WebDriver driver=driverManager.getDriver();
	
	@Given("user is on weekly page of livingstons location")
	public void user_is_on_weekly_page_of_livingstons_location() throws InterruptedException {
	...
	public void i_count_the_total_number_in_livingstons() throws InterruptedException {
	...
	public void i_click_on_products_in_livingstons_market() throws InterruptedException {
	...
	public void i_count_all_products_in_livingstons_market() throws InterruptedException {
