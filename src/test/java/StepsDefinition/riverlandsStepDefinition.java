...
public class riverlandsStepDefinition {
	
	private WebDriver driver=driverManager.getDriver();

	
	
	@Given("user is on weekly page of Riverlands")
	public void user_is_on_weekly_page_of_riverlands() throws InterruptedException {
	...
	@Then("I count the total number in Riverlands")
	public void i_count_the_total_number_in_riverlands() throws InterruptedException {
	...
	@When("I click on products in Riverlands market")
	public void i_click_on_products_in_riverlands_market() throws InterruptedException {
	...
	@And("I count all products in Riverlands market")
	public void i_count_all_products_in_riverlands_market() throws InterruptedException {
