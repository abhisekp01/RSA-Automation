...
public class wedoweeStepDefinition {
	
	private WebDriver driver=driverManager.getDriver();

	
	
	@Given("user is on all products page of Wedowee")
	public void user_is_on_all_products_page_of_wedowee() throws InterruptedException {
	...
	@And("I count the total number in Wedowee")
	public void i_count_the_total_number_in_wedowee() throws InterruptedException {
